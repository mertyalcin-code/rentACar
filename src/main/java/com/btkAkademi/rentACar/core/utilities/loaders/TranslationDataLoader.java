...
public class TranslationDataLoader implements CommandLineRunner {
	...
	private void loadTranslationData() {
		...
		if (translationDao.count() == 0) {
			...
			translations.add(new Translation(0, "Promo Code Expired", this.wordDao.getWordsByKey("promo.code.expired"),
					english));

			translations.add(new Translation(0, "Brand Limit Exceed", this.wordDao.getWordsByKey("brand.limit.exceed"),
					english));
			translations.add(
					new Translation(0, "Car Damage Listed", this.wordDao.getWordsByKey("car.damage.list"), english));
			translations.add(new Translation(0, "Registration Succesfull",
					this.wordDao.getWordsByKey("customer.registration.successful"), english));
			translations.add(new Translation(0, "Credit Cards Listed",
					this.wordDao.getWordsByKey("customer.card.detail.list"), english));
			translations.add(new Translation(0, "Total Price Calculated",
					this.wordDao.getWordsByKey("total.price.calculate"), english));
			translations.add(
					new Translation(0, "Promo Code Listed", this.wordDao.getWordsByKey("promo.code.list"), english));
			translations
					.add(new Translation(0, "Segments Listed", this.wordDao.getWordsByKey("segment.list"), english));
			...
			traslations2.add(new Translation(0, "Promosyon Kodu Artık Geçerli Değil",
					this.wordDao.getWordsByKey("promo.code.expired"), turkish));

			traslations2.add(new Translation(0, "Marka Limitine Ulaşıldı",
					this.wordDao.getWordsByKey("brand.limit.exceed"), turkish));
			traslations2.add(new Translation(0, "Araba Hasarları Listelendi",
					this.wordDao.getWordsByKey("car.damage.list"), turkish));
			traslations2.add(new Translation(0, "Kayıt Başarılı",
					this.wordDao.getWordsByKey("customer.registration.successful"), turkish));
			traslations2.add(new Translation(0, "Kredi Kartları Listelendi",
					this.wordDao.getWordsByKey("customer.card.detail.list"), turkish));
			traslations2.add(new Translation(0, "Toplam Ücret Hesaplandı",
					this.wordDao.getWordsByKey("total.price.calculate"), turkish));
			traslations2.add(new Translation(0, "Promosyon Kodu Listelendi",
					this.wordDao.getWordsByKey("promo.code.list"), turkish));
			traslations2.add(new Translation(0, "Araç Sınıfları Listelendi", this.wordDao.getWordsByKey("segment.list"),
					turkish));
